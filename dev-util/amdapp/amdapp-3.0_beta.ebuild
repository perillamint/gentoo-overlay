...
X86_AT="http://galadriel.gentoo.moe/AMD-APP-SDK-v${MY_V}-linux32-1.tar.bz2"
AMD64_AT="http://galadriel.gentoo.moe/AMD-APP-SDK-v${MY_V}-linux64.tar.bz2"
